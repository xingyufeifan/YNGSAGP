...
public class SuperDisasterAdapter extends RecyclerView.Adapter<SuperDisasterAdapter.MyViewHolder> {
    ...
    public void setOnItemClickListener(SuperDisasterAdapter.OnItemClickListener onItemClickListener) {
        this.mOnItemClickListener = onItemClickListener;
    }

    @Override
    public SuperDisasterAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //此处动态加载ViewHolder的布局文件并返回holder
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_disaster_list, null);
        SuperDisasterAdapter.MyViewHolder holderA = new SuperDisasterAdapter.MyViewHolder(view);
        return holderA;
    }

    @Override
    public void onBindViewHolder(SuperDisasterAdapter.MyViewHolder holder, final int position) {
