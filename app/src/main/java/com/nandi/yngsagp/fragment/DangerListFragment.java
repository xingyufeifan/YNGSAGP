...
public class DangerListFragment extends Fragment {
    ...
    private List<DangerListBean> disasterList;
        ...
        OkHttpHelper.sendHttpGet(getActivity(), url, new OkHttpCallback() {
            ...
            public void onSuccess(String response) {
                ...
                try {
                    ...
                    if (isSuccess) {
                        disasterList = JsonFormat.stringToList(jsonData.toString(), DangerListBean.class);
                        setAdapter();
            ...
            public void onSuccess(String response) {
                ...
                try {
                    ...
                    if (isSuccess) {
                        ...
                        disasterList.addAll(JsonFormat.stringToList(jsonData.toString(), DangerListBean.class));
    ...
    private void setAdapter() {
        ...
        dangerAdapter = new DangerAdapter(getActivity(), disasterList);
        dangerAdapter.setOnItemClickListener(new DisasterAdapter.OnItemClickListener() {
            @Override
        ...
        disasterShow.setAdapter(dangerAdapter);
