...
public class DisasterFragment extends Fragment {
    ...
    private List<DisasterUBean> beanList;

    public static DisasterFragment newInstance(String info) {
    ...
    private void initData() {
        ...
        beanList.add(new DisasterUBean("滑坡", "合肥市蜀山区天柱路88号", "2017/7/16 14:12:23"));
        beanList.add(new DisasterUBean("地陷", "南京市秦淮区贡院西街53号", "2017/8/1 9:23:00"));
        beanList.add(new DisasterUBean("崩塌", "苏州市沧浪新城杨素路18号", "2017/9/12 7:10:23"));
        beanList.add(new DisasterUBean("泥石流", "金华市双龙南街801号", "2017/9/20 15:02:23"));
        beanList.add(new DisasterUBean("不稳定", "上饶市茶圣路169号", "2017/9/25 8:54:23"));
    }
    @Override
