...
import com.nandi.yngsagp.adapter.DangerPagerAdapter;
...
public class DangerListActivity extends BaseActivity {
    ...
    private DangerPagerAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initData();
        adapter = new DangerPagerAdapter(getSupportFragmentManager(), titleList);
