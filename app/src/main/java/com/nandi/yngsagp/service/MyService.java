package com.nandi.yngsagp.service;
...
import com.nandi.yngsagp.activity.VideoActivity;
import com.nandi.yngsagp.utils.ConfigEntity;
import com.nandi.yngsagp.utils.ConfigService;
...
//			}
    ...
    public void OnAnyChatConnectMessage(boolean bSuccess) {
        if(bSuccess){
            ...
            ToastUtils.showShort("网络不通畅，正在重新连接...");
        }
    }
    ...
    public void OnAnyChatOnlineUserMessage(int dwUserNum, int dwRoomId) {
        ...
        if (isOnline){
            ...
            ToastUtils.showShort("回话邀请已过期，或对方不在房间内！");
            stopSelf();
        }
    }
